    ...
    try {
      ...
      const carpool = await prisma.carpool.create({
        data: {
          ...
          transportationType:
            TransportationType[
              data.vehicleType as keyof typeof TransportationType
            ],
  ...
  return (
    <form action={createPool}>
      <div className="flex flex-col">
        ...
        ></input>
        vehicleType:{" "}
        <select id="vehicleType" name="vehicleType" className="w-[200px]">
        ...
        Apple Pay:{" "}
        <input type="checkbox" id="takesApplePay" name="takesApplePay"></input>
        Zelle: <input type="checkbox" id="takesZelle" name="takesZelle"></input>
        Meetup Directions:{" "}
        <input
          type="text"
          id="meetupDirections"
          name="meetupDirections"
          className="w-[200px]"
        ></input>
        Description:{" "}
        <input
